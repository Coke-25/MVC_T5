...
public class Controlador implements WindowListener, ActionListener, ItemListener
{
	...
	public Controlador(Modelo modelo, Vista vista)
	{
		...
		vista.darNuevo.addWindowListener(this);
		vista.darEliminar.addWindowListener(this);
		vista.darConsultar.addWindowListener(this);
		vista.darModificar.addWindowListener(this);
		...
		vista.listaEliminar.addItemListener(this);
		vista.listaModificar.addItemListener(this);
	}
	...
	{	
		...
		{
			vista.darNuevo.setVisible(true);
		}
		else if(vista.consultar.equals(evento.getSource()))
		{
			vista.darConsultar.setVisible(true);
		}
		...
		{	
			...
			vista.darEliminar.setVisible(true);
		}
		else if(vista.modificar.equals(evento.getSource()))
		{
			...
			vista.darModificar.setVisible(true);
		}
		//Botones
	...
	public void windowClosing(WindowEvent arg0) {
		...
		else if(vista.darNuevo.isActive())
		{
			vista.darNuevo.setVisible(false);
		}
		else if(vista.darEliminar.isActive())
		{
			vista.darEliminar.setVisible(false);
		}
		else if(vista.darModificar.isActive())
		{
			vista.darModificar.setVisible(false);
		}
		else if(vista.darConsultar.isActive())
		{
			vista.darConsultar.setVisible(false);
		}
